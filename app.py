...
document.getElementById('themeBtn').onclick=()=>{let dark=document.body.classList.contains('dark');if(dark)document.body.classList.remove('dark');else document.body.classList.add('dark');};
