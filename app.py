...
<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover"><title>Чатик · Вход</title><style>
*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Inter',system-ui;background:radial-gradient(circle at 10% 20%, #0f0c29, #302b63, #24243e);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:20px}.card{background:rgba(15,25,45,0.7);backdrop-filter:blur(16px);border-radius:48px;padding:40px;max-width:400px;width:100%;text-align:center;border:1px solid rgba(139,92,246,0.3);box-shadow:0 0 40px rgba(139,92,246,0.2)}h1{background:linear-gradient(135deg,#a78bfa,#c084fc);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-size:32px;margin-bottom:8px}.subtitle{color:#94a3b8;margin-bottom:32px}input{width:100%;padding:14px 18px;background:rgba(255,255,255,0.05);border:1px solid rgba(139,92,246,0.3);border-radius:32px;margin-bottom:16px;color:#fff;font-size:16px;outline:none;transition:0.2s}input:focus{border-color:#a78bfa;box-shadow:0 0 10px rgba(139,92,246,0.3)}input::placeholder{color:#64748b}button{width:100%;padding:14px;background:linear-gradient(135deg,#8b5cf6,#6366f1);border:none;border-radius:32px;color:#fff;font-size:16px;font-weight:600;cursor:pointer;transition:0.2s}button:hover{transform:scale(1.02);box-shadow:0 0 20px rgba(139,92,246,0.5)}.error{background:rgba(239,68,68,0.2);border:1px solid rgba(239,68,68,0.3);color:#fecaca;padding:12px;border-radius:24px;margin-bottom:20px}.footer{margin-top:24px;color:#94a3b8}a{color:#a78bfa;text-decoration:none}
</style></head>
...
<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover"><title>Чатик · Регистрация</title><style>
*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Inter',system-ui;background:radial-gradient(circle at 10% 20%, #0f0c29, #302b63, #24243e);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:20px}.card{background:rgba(15,25,45,0.7);backdrop-filter:blur(16px);border-radius:48px;padding:40px;max-width:400px;width:100%;text-align:center;border:1px solid rgba(139,92,246,0.3);box-shadow:0 0 40px rgba(139,92,246,0.2)}h1{background:linear-gradient(135deg,#a78bfa,#c084fc);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-size:32px;margin-bottom:32px}input{width:100%;padding:14px 18px;background:rgba(255,255,255,0.05);border:1px solid rgba(139,92,246,0.3);border-radius:32px;margin-bottom:16px;color:#fff;font-size:16px;outline:none}input:focus{border-color:#a78bfa;box-shadow:0 0 10px rgba(139,92,246,0.3)}input::placeholder{color:#64748b}button{width:100%;padding:14px;background:linear-gradient(135deg,#8b5cf6,#6366f1);border:none;border-radius:32px;color:#fff;font-size:16px;font-weight:600;cursor:pointer;transition:0.2s}button:hover{transform:scale(1.02);box-shadow:0 0 20px rgba(139,92,246,0.5)}.error{background:rgba(239,68,68,0.2);border:1px solid rgba(239,68,68,0.3);color:#fecaca;padding:12px;border-radius:24px;margin-bottom:20px}.footer{margin-top:24px;color:#94a3b8}a{color:#a78bfa;text-decoration:none}
</style></head>
...
*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Inter',system-ui;background:radial-gradient(circle at 10% 20%, #0f0c29, #302b63, #24243e);height:100vh;display:flex;overflow:hidden}.app{display:flex;width:100%;height:100%}.sidebar{width:280px;background:rgba(15,25,45,0.7);backdrop-filter:blur(12px);border-right:1px solid rgba(139,92,246,0.2);display:flex;flex-direction:column;overflow-y:auto}.user-card{text-align:center;padding:24px;margin:16px;background:linear-gradient(135deg,rgba(139,92,246,0.2),rgba(99,102,241,0.2));border-radius:28px;border:1px solid rgba(139,92,246,0.3);cursor:pointer;transition:0.2s}.user-card:hover{transform:scale(1.02);border-color:#a78bfa}.user-avatar{font-size:56px}.user-name{font-size:18px;font-weight:700;color:#fff;margin-top:4px}.user-bio{font-size:11px;color:#94a3b8;margin-top:5px}.section-title{font-weight:600;padding:16px 20px 8px 20px;color:#a78bfa;font-size:11px;text-transform:uppercase;letter-spacing:1px}.room-item,.user-item{padding:12px 20px;margin:4px 12px;border-radius:16px;cursor:pointer;display:flex;align-items:center;gap:12px;transition:0.2s;color:#e2e8f0}.room-item:hover,.user-item:hover{background:rgba(139,92,246,0.2);transform:translateX(4px)}.room-item.active{background:linear-gradient(135deg,#8b5cf6,#6366f1);color:#fff}.add-room{display:flex;gap:8px;margin:12px}.add-room input{flex:1;padding:10px;background:rgba(255,255,255,0.05);border:1px solid rgba(139,92,246,0.3);border-radius:40px;outline:none;color:#fff}.add-room input::placeholder{color:#64748b}.add-room button{background:linear-gradient(135deg,#8b5cf6,#6366f1);border:none;border-radius:40px;padding:8px 20px;color:#fff;cursor:pointer}.chat-area{flex:1;display:flex;flex-direction:column;background:rgba(0,0,0,0.2)}.chat-header{padding:16px 24px;background:rgba(15,25,45,0.6);backdrop-filter:blur(8px);border-bottom:1px solid rgba(139,92,246,0.2);display:flex;justify-content:space-between;align-items:center;color:#fff}.messages{flex:1;overflow-y:auto;padding:20px;display:flex;flex-direction:column;gap:12px}.message{display:flex;gap:12px;align-items:flex-start;animation:fadeIn 0.2s}.message-own{justify-content:flex-end}@keyframes fadeIn{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}.message-avatar{width:40px;height:40px;background:linear-gradient(135deg,#8b5cf6,#6366f1);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:18px;cursor:pointer;flex-shrink:0;box-shadow:0 0 15px rgba(139,92,246,0.3)}.message-content{background:rgba(255,255,255,0.05);padding:10px 16px;border-radius:20px;max-width:65%;word-break:break-word;color:#e2e8f0}.message-own .message-content{background:linear-gradient(135deg,#8b5cf6,#6366f1);color:#fff}.message-name{font-weight:700;font-size:13px;display:flex;align-items:center;gap:6px;margin-bottom:4px}.message-time{font-size:9px;opacity:0.6;margin-left:6px}.message-text{font-size:14px;line-height:1.4}.badge-owner{background:#ef4444;font-size:8px;padding:2px 6px;border-radius:20px}.badge-admin{background:#10b981;font-size:8px;padding:2px 6px;border-radius:20px}.online-dot{width:8px;height:8px;background:#10b981;border-radius:50%;display:inline-block;margin-right:8px;box-shadow:0 0 5px #10b981}.system-msg{text-align:center;font-size:11px;color:#94a3b8;padding:6px;margin:4px 0}.typing{padding:6px 24px;font-size:11px;color:#94a3b8;font-style:italic}.input-area{display:flex;gap:12px;padding:16px 24px;background:rgba(15,25,45,0.6);backdrop-filter:blur(8px);border-top:1px solid rgba(139,92,246,0.2)}.input-area input{flex:1;padding:14px 20px;background:rgba(255,255,255,0.05);border:1px solid rgba(139,92,246,0.3);border-radius:40px;outline:none;color:#fff;font-size:14px}.input-area input::placeholder{color:#64748b}.input-area button{background:linear-gradient(135deg,#8b5cf6,#6366f1);border:none;border-radius:50%;width:48px;height:48px;color:#fff;cursor:pointer;font-size:18px;display:flex;align-items:center;justify-content:center;transition:0.2s}.input-area button:hover{transform:scale(1.05);box-shadow:0 0 15px rgba(139,92,246,0.5)}.btn-settings,.btn-logout{margin:8px 12px;padding:12px;border-radius:20px;cursor:pointer;border:none;font-weight:500}.btn-settings{background:linear-gradient(135deg,#8b5cf6,#6366f1);color:#fff}.btn-logout{background:rgba(239,68,68,0.2);color:#fecaca;border:1px solid rgba(239,68,68,0.3)}.modal{display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;z-index:1000}.modal-content{background:rgba(15,25,45,0.95);backdrop-filter:blur(16px);border-radius:28px;padding:24px;max-width:350px;width:90%;border:1px solid rgba(139,92,246,0.3)}.modal-content input,.modal-content textarea{width:100%;padding:12px;margin:8px 0;border-radius:24px;background:rgba(255,255,255,0.05);border:1px solid rgba(139,92,246,0.3);color:#fff;outline:none}.modal-content button{background:linear-gradient(135deg,#8b5cf6,#6366f1);color:#fff;border:none;padding:12px;border-radius:24px;width:100%;cursor:pointer;margin-top:8px}.close{float:right;font-size:24px;cursor:pointer;color:#fff}.profile-avatar{font-size:64px;text-align:center;margin-bottom:12px}.profile-name{font-size:20px;font-weight:700;text-align:center;color:#fff;margin-bottom:4px}.profile-role{text-align:center;font-size:12px;color:#a78bfa;margin-bottom:16px}.profile-bio{background:rgba(255,255,255,0.05);padding:12px;border-radius:20px;margin:16px 0;font-size:14px;color:#e2e8f0}.profile-actions{display:flex;gap:10px;margin-top:16px}.profile-actions button{flex:1;padding:10px;border-radius:24px;border:none;cursor:pointer;font-weight:500}.friend-request-item{display:flex;justify-content:space-between;align-items:center;padding:12px;margin:8px 0;background:rgba(139,92,246,0.1);border-radius:20px;color:#e2e8f0}.emoji-picker{position:absolute;bottom:90px;left:20px;background:rgba(15,25,45,0.95);backdrop-filter:blur(12px);border-radius:20px;padding:12px;display:none;grid-template-columns:repeat(6,1fr);gap:8px;border:1px solid rgba(139,92,246,0.3);z-index:1000}.emoji{font-size:28px;cursor:pointer;text-align:center;padding:6px;border-radius:12px}.emoji:hover{background:rgba(139,92,246,0.3)}.notify-btn{position:relative;background:none;border:none;cursor:pointer;font-size:20px;padding:8px;border-radius:50%;color:#fff}.notify-badge{position:absolute;top:-2px;right:-2px;background:#ef4444;color:#fff;font-size:10px;min-width:18px;height:18px;border-radius:20px;display:none;align-items:center;justify-content:center}.mobile-menu-btn{display:none;font-size:24px;background:none;border:none;cursor:pointer;padding:8px;color:#fff}@media(max-width:680px){.sidebar{position:fixed;left:-280px;z-index:1000;transition:left 0.3s;height:100%}.sidebar.open{left:0}.sidebar-overlay{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.7);z-index:999;display:none}.mobile-menu-btn{display:block}.chat-header{padding:12px 16px}}
</style>
</head>
<body>
...
<div id="settingsModal" class="modal"><div class="modal-content"><span class="close" id="closeSettings">&times;</span><h3 style="color:#fff;margin-bottom:16px">⚙️ Настройки</h3><button id="themeBtn" style="background:#8b5cf6">🌙 Тёмная тема</button><h4 style="margin:16px 0 8px;color:#a78bfa">👑 КОМАНДЫ</h4><p style="font-size:12px;color:#e2e8f0">• /giveadmin ИМЯ — выдать админку</p><p style="font-size:12px;color:#e2e8f0">• /unadmin ИМЯ — снять админку</p><h4 style="margin:16px 0 8px;color:#a78bfa">📨 ЗАЯВКИ В ДРУЗЬЯ</h4><div id="requestsList"></div></div></div>
<div id="notifyModal" class="modal"><div class="modal-content"><span class="close" id="closeNotifyModal">&times;</span><h3 style="color:#fff;margin-bottom:16px">🔔 Уведомления</h3><div id="notificationsList"></div></div></div>
...
if(document.getElementById('menuBtn')){document.getElementById('menuBtn').onclick=()=>{sidebar.classList.add('open');overlay.style.display='block';};}
...
function updateNotificationsList(){let container=document.getElementById('notificationsList');if(notifications.length===0&&pendingFriendRequests.length===0){container.innerHTML='<p style="color:#94a3b8;text-align:center;padding:16px">Нет уведомлений</p>';return;}let html='';pendingFriendRequests.forEach(req=>{html+=`<div class="friend-request-item"><span>📨 Заявка от ${escape(req)}</span><button onclick="acceptReq('${escape(req)}')" style="background:#10b981;border:none;border-radius:20px;padding:6px 14px;color:#fff;cursor:pointer">Принять</button></div>`;});notifications.forEach(n=>{html+=`<div class="friend-request-item"><div><strong>${escape(n.title)}</strong><br><small>${escape(n.text)}</small><br><span style="font-size:10px;color:#94a3b8">${n.time}</span></div></div>`;});container.innerHTML=html;}
...
function showUserProfileModal(name){
    fetch('/user_info/'+encodeURIComponent(name)).then(r=>r.json()).then(data=>{
        let actions='';
        if(!data.is_friend&&name!==username)actions+=`<button onclick="addFriendFromModal('${name}')" style="background:#8b5cf6;color:#fff">➕ В друзья</button>`;
        if(data.is_friend)actions+=`<button onclick="removeFriendFromModal('${name}')" style="background:#ef4444;color:#fff">❌ Удалить</button>`;
        if(role==='owner'||role==='admin'){
            ...
            else if(data.user_role!=='owner')actions+=`<button onclick="giveAdminFromModal('${name}')" style="background:#10b981;color:#fff">⭐ Выдать админку</button>`;
        }
...
window.addFriendFromModal=name=>{fetch('/add_friend',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({friend:name})}).then(r=>r.json()).then(data=>{addSystem(data.message);addNotification('Заявка',`Отправлена ${name}`);document.getElementById('userModal').style.display='none';});};
window.removeFriendFromModal=name=>{fetch('/remove_friend',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({friend:name})}).then(r=>r.json()).then(data=>{addSystem(data.message);addNotification('Друг',`${name} удалён`);document.getElementById('userModal').style.display='none';});};
window.giveAdminFromModal=name=>{fetch('/give_admin',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({username:name})}).then(r=>r.json()).then(data=>{addSystem(data.message);addNotification('Админ',`${name} назначен`);document.getElementById('userModal').style.display='none';});};
window.unadminUser=name=>{fetch('/remove_admin',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({username:name})}).then(r=>r.json()).then(data=>{addSystem(data.message);addNotification('Админ',`У ${name} снято`);document.getElementById('userModal').style.display='none';});};
window.acceptReq=name=>{fetch('/accept_friend',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({friend:name})}).then(r=>r.json()).then(data=>{addSystem(data.message);addNotification('Друг',`Вы приняли заявку от ${name}`);pendingFriendRequests=pendingFriendRequests.filter(r=>r!==name);updateNotifyBadge();updateNotificationsList();loadRequests();});};
...
function addMessage(id,name,text,time,isOwn,avatar){let div=document.createElement('div');div.className=`message ${isOwn?'message-own':''}`;let roleBadge='';if(name==='MrAizex')roleBadge='<span class="badge-owner">ВЛ</span>';else if(name==='dimooon')roleBadge='<span class="badge-admin">АДМ</span>';div.innerHTML=`<div class="message-avatar" onclick="showUserProfileModal('${escape(name)}')">${avatar||'👤'}</div><div class="message-content"><div class="message-name">${escape(name)}${roleBadge}<span class="message-time">${time}</span></div><div class="message-text">${escape(text)}</div></div>`;msgDiv.appendChild(div);msgDiv.scrollTop=msgDiv.scrollHeight;}
...
socket.on('friend_request',data=>{addNotification('Заявка в друзья',`${data.from} хочет добавить вас`);loadRequests();});
